...
| RESEARCH | R-04 | Compatibility is a projection, never a second authority | 04–05 | COVERED | Authenticated base-table access closes; exact and compatibility caller-bound RPCs preserve full-range strings. |
...
| RESEARCH | R-07 | Supabase/FakeRest/live HTTP parity and exact preview | 05–06 | COVERED | Live RPC boundary precedes FakeRest/preview parity under strict dependency. |
...
| CONTEXT | D-07 | Submitted percentage text retained as non-authoritative evidence | 01, 04–06 | COVERED | Exact field is `submitted_percentage`. |
...
| CONTEXT | D-16 | Expand-contract and projection-only legacy compatibility | 04–05 | COVERED | Exact authority, authenticated table closure, and caller-bound RPC cutover. |
...
| M2 | Plans 04–05 use/test `numeric(19,2)` compatibility strings for both signed-bigint endpoints and overflow. |
