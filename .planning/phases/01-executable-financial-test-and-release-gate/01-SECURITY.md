...
|-----------|----------|-----------|-------------|-------------------------|--------|
| T-01-01 | Elevation of Privilege | Required checks and live main ruleset | mitigate | Organization ownership and authenticated exact no-bypass ruleset readback pass. Replacement PR #3 at `04c2926` passes all four fast and all six financial contexts, including release security; the missing independent reviewer still prevents the required merge-group observation. | open |
...
- PR #2 at `9bb5f6f3c3e377302d4e8dfe91c9aad6c5f60688`: all fast checks and migration-clean, migration-upgrade, database-contracts, edge-provider-contracts, and replay-concurrency pass; the newer release-security head awaits live CI.
