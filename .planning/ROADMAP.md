...
- [ ] 03-03-PLAN.md — Convert invoices, line items, and automation amount authority with immutable upgrade proof.

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 03-04-PLAN.md — Cut Supabase, FakeRest, and invoice preview over to the exact boundary contract.

**Wave 5** *(blocked on Wave 4 completion)*

- [ ] 03-05-PLAN.md — Couple every exact contract into protected lanes and record integrated release proof.
...
| 3. Exact Money and Rounding Contract | 0/5 | Planned    |  |
